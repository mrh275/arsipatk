...
<body>
    <table>
        <thead>
            <tr>
                <th colspan="7" style="text-align: center; font-weight: 600; fontsize: 1.8rem;">
                    <h1>Laporan Data Permintaan Barang</h1>
                </th>
            </tr>
            <tr>
                <th colspan="7" style="text-align: center; font-weight: 500; fontsize: 1.2rem">
        ...
        <tbody>
            @foreach ($dataPermintaan as $index => $item)
                <tr>
                    ...
                    <td class="text-right">{{ $item->jumlah_permintaan }}</td>
                    <td>{{ $item->barang->satuan_barang }}</td>
                    <td>{{ \Carbon\Carbon::parse($item->tanggal_permintaan)->format('d F Y') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
